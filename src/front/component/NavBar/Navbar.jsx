        ...
        >
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              ...
              <Nav.Link className="btn  "  as={Link} to={"/Care-Me/Prediction"}>
                Diagnoses
              </Nav.Link>
            ...
            <Nav style={
              ...
              <Link id="lang1" className=" nav-link nav-item btn  active" >Sign In</Link>

              <Link id="lang2" className="nav-link nav-item btn  active " >Sign Up</Link>
